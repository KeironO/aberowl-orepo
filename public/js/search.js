            ...
            "dataSrc": function(result) {
                ...
                for (var m in result) {
                    ...
                    for (var i in result[m]) {
                        ...
                        datatable[rowcount][0] = result[m][i][0].label + " (<small><tt>" + iri + "</tt></small>)" ||
                            result[m][i][0].oboid + " (<small><tt>" + iri + "</tt></small>)" || "<small><tt>" + iri + "</tt></small>";
                        datatable[rowcount][0] = "<td>"+datatable[rowcount][0]+"</td><td>"+datatable[rowcount][3]+"</td>";
                        datatable[rowcount][3] = '';
